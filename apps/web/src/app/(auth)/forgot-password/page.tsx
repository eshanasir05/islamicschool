        ...
        {sent ? (
          ...
          <>
            ...
            {error === 'rate_limit' && (
              ...
              >
                <strong>Too many requests.</strong> Supabase limits password reset emails on the
                free tier. Please wait a minute and try again. If you still cannot reset your
                password, contact your school administrator.
              </div>
            )}
            {error === 'send_failed' && (
