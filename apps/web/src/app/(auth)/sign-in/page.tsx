        ...
        <div className="sign-in-card">
          ...
          <div className="sign-in-sent">
            ...
            <p style={{ fontSize: 13, color: 'var(--muted)', margin: '12px 0' }}>
              Don&apos;t see it? Check your spam folder. Magic link delivery requires custom SMTP
              configuration in Supabase — for the demo, use password sign-in instead.
            </p>
      ...
      <div className="sign-in-card">
        ...
        {mode === 'magic' && (
          <p style={{ fontSize: 12, color: 'var(--muted)', textAlign: 'center', marginTop: 6 }}>
            Magic links require email delivery to be configured by your school. Use password sign-in
            if your school has not enabled them.
          </p>
        )}
      </div>
    </div>
